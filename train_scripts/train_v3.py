...
SAVE_DIR = Path("/home/veday28/SageAir/models/v3_clip_haze")
SAVE_DIR.mkdir(parents=True, exist_ok=True)

PM25_THRESHOLD = 15.0    # Lower threshold for better class balance
IMG_SIZE = 224
...
print("\n=== Training v3 (CLIP + haze aug + threshold=15) ===")
...
print(f"  {'Metric':<15} {'v1':<12} {'v2':<12} {'v3':<12}")
if v1_path.exists():
    with open(v1_path) as f:
        v1 = json.load(f)
    print(f"  {'Threshold':<15} {'35':<12} {'35':<12} {str(PM25_THRESHOLD):<12}")
    print(f"  {'Backbone':<15} {'ResNet50':<12} {'ResNet50':<12} {'CLIP-ViT':<12}")
    print(f"  {'Test Acc':<15} {v1['test_acc']:<12.4f} {'':<12} {test_acc:<12.4f}")
if v2_path.exists():
    with open(v2_path) as f:
        v2 = json.load(f)
    print(f"  {'Test F1':<15} {v1['test_f1']:<12.4f} {v2['test_f1']:<12.4f} {test_f1:<12.4f}")
    print(f"  {'Test AUC':<15} {v1['test_auc']:<12.4f} {v2['test_auc']:<12.4f} {test_auc:<12.4f}")
    print(f"  {'Test Acc':<15} {v1['test_acc']:<12.4f} {v2['test_acc']:<12.4f} {test_acc:<12.4f}")
